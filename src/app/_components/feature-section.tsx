import { Timer, Zap, ZoomIn, PersonStanding } from "lucide-react";

export default function FeatureSection() {
  return (
    <section className="py-32">
        <div className="container">
          <p className="mb-4 text-xs text-muted-foreground">Why EasyTap?</p>
          <h2 className="text-3xl font-semibold md:text-5xl">
            A better way to manage your menu & orders
          </h2>
