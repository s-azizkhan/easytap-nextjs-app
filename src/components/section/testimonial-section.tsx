    ...
    <section className="py-14">
      <div className="container px-4 mx-auto">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <h2 className="mb-8  md:text-5xl lg:text-6xl font-bold tracking-tight text-gray-900 sm:text-5xl">
            Hear from our satisfied customers
            <span className="relative inline-flex mx-4">
              <span className="absolute inset-0 flex items-center justify-center">
                <span className="w-full h-full bg-indigo-100 rounded-full blur-xl"></span>
              </span>
          ...
          <p className="mb-10 text-xl leading-snug text-gray-600">
